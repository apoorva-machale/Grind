...
class OutputValidator:
    ...
    @classmethod
    def _normalize_response(cls, response: Union[str, Dict[str, Any]]) -> str:
    ...
    @classmethod
    def validate(cls, response: Union[str, Dict[str, Any]]) -> Tuple[bool, List[str]]:
        """
    ...
    def invoke(self, user_input: str) -> Dict[str, Any]:
        ...
        try:
            template = ChatPromptTemplate.from_messages([
                ("system", CLOUDCART_HARDENED_SYSTEM_PROMPT),
